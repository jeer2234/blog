...
def post_detail(request, year, month, day, post):
    ...
    if request.method == 'POST':
        ...
        if comment_form.is_valid():
            ...
            comment_form = CommentForm() #cambios con especto al codigo original para que 
            #par que el formulrio este vacio y se pueda mandar un comentrio . sin importar que ya se haya mandado un comentario
            #con el metodo post
    else:
